              ...
              <div className="flex items-center justify-center gap-4 mt-6">
                {[1, 2, 3].map(etape => (
                  <div key={etape} className="flex items-center">
                    <div className={`w-10 h-10 rounded-full flex items-center justify-center font-semibold ${etapeActuelle === etape
                    ...
                    {etape < 3 && (
                      <div className={`w-16 h-1 mx-2 ${etapeActuelle > etape ? 'bg-green-500' : 'bg-gray-200'
                        }`} />
                    )}
                  </div>
                ))}
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 ${errors.titre ? 'border-red-500' : 'border-gray-300'
                      }`}
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    rows="8"
                    className={`w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 resize-none ${errors.description ? 'border-red-500' : 'border-gray-300'
                      }`}
              ...
              <div className="space-y-6">
                ...
                <div className="flex gap-4 pt-4">
                  ...
                  <button
                    ...
                    className={`flex-1 py-3 rounded-lg font-semibold flex items-center justify-center gap-2 ${competencesSelectionnees.length === 0
