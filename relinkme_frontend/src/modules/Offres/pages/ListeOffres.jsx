...
import { Briefcase, Search, DollarSign, Calendar, Building2, Clock } from 'lucide-react';
              ...
              {filteredOffres.map(offre => (
                ...
                >
                  <div className="p-6">
                    ...
                    {/* Description */}
                    <p className="text-gray-700 mb-4 line-clamp-3">{offre.description}</p>

                    {/* ✅ Actions avec les bonnes URLs */}
